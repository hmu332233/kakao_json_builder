...
class ChatPreviewContainer extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    };
  ...
  render() {
    const data = Object.keys(MESSAGE.TYPE).map(key => {
      return {
        type: MESSAGE.TYPE[key],
        data: DATA[key]
      }
    });
    console.log(data);
    return <ChatPreview chats={data} />;
  }
}

ChatPreviewContainer.propTypes = {
};
ChatPreviewContainer.defaultProps = {
};
